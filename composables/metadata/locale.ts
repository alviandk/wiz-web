import useLocaleStore from '~/stores/metadata/locale'
import { availableLocales } from '~/i18n'
import { isString } from '~/universals/value'
import { fromCookies, fromHeader, fromQueryString } from './extractor'
...
export const useLocaleExtractor = () => {
  ...
  function userOrFallbackLocale(value: any, preConditionalResult = true) {
    ...
    const defaultValue = useI18n().fallbackLocale.value as string
